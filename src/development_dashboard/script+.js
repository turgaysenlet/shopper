    ...
    try {
        ...
        tasks.forEach(task => {
            ...
            listItem.addEventListener('click', () => {
                ...
                if (barcode) {
                    updateProductLookupIframe(barcode);
                }
            });
...
function updateProductLookupIframe(barcode) {
    const iframe = document.getElementById('productIframe');
    if (iframe) {
        iframe.src = `https://upcitemdb.com/upc/${barcode}`;
    } else {
        console.error('Product iframe not found');
    }
}
